...
`落樱` 是维护者创作的示例主题名称，不指向、不以名称描绘、也不声称获得任何角色、作品、艺术家或权利方的认可。内置壁纸、图标和宣传截图由维护者授权随本仓库、其 Fork 和发布包公开再分发；它们不属于 MIT 软件许可证的授权范围。素材不得被单独授权、转售或用于暗示任何第三方的认可。具体范围见 [assets/ARTWORK_NOTICE.md](assets/ARTWORK_NOTICE.md)。
